...
function onPage(output, page) {
    ...
    .then(function(resultPage) {
        ...
        console.log("Generating Webpage context");
        ...
        // Render the theme
        console.log("Generating Webpage render");
        return Templating.renderFile(engine, prefix + '/page.html', context)

        // Write it to the disk
        .then(function(tplOut) {
            var ret =  writeFile(output, filePath, tplOut.getContent());
            console.log("Written Webpage to disk");
            return ret
        });
    });
}
